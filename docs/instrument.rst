...
Refer to the ``pandeia`` `documentation <https://jwst-docs.stsci.edu/jwst-exposure-time-calculator-overview/jwst-etc-pandeia-engine-tutorial/pandeia-quickstart#PandeiaQuickstart-Appendices>`_ for supported instruments and modes.
...
Refer to the ``pandeia`` `documentation <https://jwst-docs.stsci.edu/jwst-exposure-time-calculator-overview/jwst-etc-pandeia-engine-tutorial/pandeia-quickstart#PandeiaQuickstart-Appendices>`_ for dispersers and filters per instrument and mode.
...
By default, the SNR is evaluated at the `reference wavelength <https://jwst-docs.stsci.edu/jwst-exposure-time-calculator-overview/jwst-etc-calculations-page-overview/jwst-etc-wavelength-of-interest#gsc.tab=0>`_ of the selected
